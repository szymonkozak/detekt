...
# HasMetrics  
 [jvm] Adds metric container behaviour.  
...
| [metricByType](metric-by-type.md)| [jvm]  <br>Brief description  <br>Finds the first metric matching given [type]().  <br>Content  <br>open fun [metricByType](metric-by-type.md)(type: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)): [Metric](../-metric/index.md)?  <br><br><br>
